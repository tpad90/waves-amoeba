...
let sound;
let fft;
let volumeThreshold = 0.8; // Initial volume threshold
...
function setup() {
  ...
  fft = new p5.FFT();
  analysisStartTime = millis(); // Initialize analysis start time
}
...
function touchStarted() {
  mouseClicked(); // Call mouseClicked() for touch events as well
  return false;
}
